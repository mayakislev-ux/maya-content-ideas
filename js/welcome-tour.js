...
const STEPS = [
  ...
  },
  {
    ...
    emoji: '✨',
    title: 'בית',
    body: 'כאן מתחילים - ברגע שעולה לכם רעיון, כותבים אותו כאן ישר, בלי טפסים ובלי לחשוב על קטגוריה או דירוג. את זה משלימים אחר כך.',
  },
  {
    target: '#tab-archive',
    emoji: '📂',
  ...
  },
  {
    ...
    emoji: '📖',
    title: 'מרכז למידה',
    body: '11 דרכים אמיתיות למצוא רעיונות לתוכן, מפת הדרכים ותכנית התוכן, ואפשרות לשתף חוות דעת - הכל במקום אחד.',
  },
  {
    emoji: '💜',
