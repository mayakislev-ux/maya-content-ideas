...
exports.classifyInspirationSubcategories = onCall(
  ...
  async (request) => {
    ...
    const REFUSAL_PATTERN = /^(אני לא יכול|אינני יכול|איני יכול|לא ניתן|I cannot|I appreciate|I'm unable)|אינו קשור|אינה קשור|לא קשור|אינו קריא|אינה קריאה|לא קריא|אינו מובן|אינה מובנת/;
